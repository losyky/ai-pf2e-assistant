...
export interface MazeLayout {
  ...
  /** The connectivity graph used to generate this layout (for preview rendering) */
  graph?: MazeGraph;
}
...
// ============================================================
// Maze graph (generated by Growing Tree before template assignment)
// ============================================================
...
export interface MazeGraphNode {
  ...
  roomType: RoomType;
  depth: number;
  /** Which sides of this cell have connections to neighbours */
  connections: EdgeSide[];
}

export interface MazeGraphEdge {
  fromId: number;
  toId: number;
  /** Direction from `fromId`'s perspective */
  side: EdgeSide;
}
